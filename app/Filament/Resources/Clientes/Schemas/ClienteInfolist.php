...
{      
    private static function getPedidosRepeatable(string $nombre): RepeatableEntry
    {
        return RepeatableEntry::make($nombre)
            ...
            ->table([
                ...
                TableColumn::make('Estado Vencimiento'),
                ...
                ->columnSpanFull()
                    ->tabs([
                        ...
                        Tab::make('Pedidos En Cartera')
                            ->badge(fn ($record) => $record->pedidos()->where('estado_pago', 'EN_CARTERA')->count())
