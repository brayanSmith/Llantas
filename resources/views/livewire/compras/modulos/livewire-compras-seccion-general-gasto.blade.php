<div class="rounded-2xl border border-gray-200 bg-white shadow-sm dark:border-gray-700 dark:bg-gray-900 dark:shadow-none">
    <div class="flex items-center justify-between border-b border-gray-100 px-6 py-4 dark:border-gray-800">
        <div class="flex items-center gap-3">
            <div class="h-9 w-9 rounded-full bg-sky-50 text-sky-600 flex items-center justify-center dark:bg-sky-500/10 dark:text-sky-300">
            ...
            <div>
                <h3 class="text-base font-semibold text-gray-900 dark:text-gray-100">Datos del Gasto</h3>
                <p class="text-xs text-gray-500 dark:text-gray-400">Informacion general del gasto</p>
            </div>
        </div>
    </div>
