    ...
    <div>
        ...
        <div class="grid grid-cols-1 md:grid-cols-2 lg:grid-cols-3 gap-4">
            ...
            <div wire:ignore>
                ...
                <x-select-dinamico label="Proveedor" placeholder="Seleccione un proveedor" model="proveedorAbonoIngresado"
            ...
            <div class="flex items-end">
                <button @click="buscarComprasEnCartera()"
                    ...
                    :disabled="!proveedorAbonoIngresado || isLoading">
    ...
    <div>
        <div class="grid grid-cols-1 md:grid-cols-3 gap-4">
            ...
            <div class="flex items-center bg-white dark:bg-gray-700 rounded p-3 border border-gray-200 dark:border-gray-600 shadow-sm">
                ...
                <div class="ml-3">
                    <p class="text-xs font-semibold text-gray-500 dark:text-gray-400 uppercase">Compras Seleccionadas</p>
                    <p class="text-2xl font-bold text-gray-900 dark:text-white" x-text="cantidadComprasSeleccionadas">0</p>
                </div>
            </div>
