<div class="space-y-6">
    <!-- Sección: Marca e Información Básica -->
    <div class="bg-white dark:bg-gray-800 rounded-lg shadow p-6 border border-gray-200 dark:border-gray-700">
        ...
        <div class="grid grid-cols-1 md:grid-cols-4 gap-4">
            ...
            <div>
                ...
                <input type="text" x-model="producto.descripcion_producto" @input="actualizarConcatenacion()" class="input-pedido" />
            </div>
            <div>
    ...
    <!-- Sección: Otros Datos -->
    <div class="bg-white dark:bg-gray-800 rounded-lg shadow p-6 border border-gray-200 dark:border-gray-700">
        {{--<h3 class="text-lg font-semibold text-gray-800 dark:text-gray-100 mb-4">Otros Datos</h3>--}}
        <div class="grid grid-cols-1 md:grid-cols-2 gap-4">

            <div class="md:col-span-2">
                <x-image-upload
                    property="imagen_producto"
                    path="imagenProductoPath"
                    deleteMethod="eliminarImagenProducto"
