                ...
                <div class="bg-grey-100 dark:bg-neutral-800 rounded-2xl shadow-lg">
                    <div
                        ...
                        <div class="w-full mb-2">
                            ...
                            <p x-text="product.concatenar_codigo_nombre"
                                class="text-xs md:text-sm text-gray-700 dark:text-gray-300 mt-1 font-bold">
                        ...
                        <div class="flex flex-row items-center gap-3 md:grid md:grid-cols-12 md:gap-4">
                            ...
                            <div
                                ...
                                <template x-if="product.imagen_producto">
                                    <img :src="`/storage/${product.imagen_producto}`" :alt="product.nombre_producto"
                            ...
                            <div class="flex-1 md:col-span-6 ml-2 md:ml-0">
                                <p class="text-[10px] md:text-xs text-gray-800 dark:text-gray-100 mt-1">DETAL:
                                    <strong
                                        x-text="new Intl.NumberFormat().format((isNaN(product.valor_detal) ? 0 : parseFloat(product.valor_detal)))"></strong>
                                </p>
                                <p class="text-[10px] md:text-xs text-gray-800 dark:text-gray-100 mt-1">MAYORISTA:
                                    <strong
                                        x-text="new Intl.NumberFormat().format((isNaN(product.valor_mayorista) ? 0 : parseFloat(product.valor_mayorista)))"></strong>
                                </p>
                                <p class="text-[10px] md:text-xs text-gray-800 dark:text-gray-100 mt-1">SIN INSTALACIÓN:
                                    <strong
                                        x-text="new Intl.NumberFormat().format((isNaN(product.valor_sin_instalacion) ? 0 : parseFloat(product.valor_sin_instalacion)))"></strong>
                                </p>
                                ...
                                <p class="text-[10px] md:text-xs text-gray-800 dark:text-gray-100 mt-1">STOCK:
                                    ...
                                    <template x-if="cantidadEnCarrito">
                                        <span class="text-[10px] md:text-xs text-gray-500 dark:text-gray-400 ml-2">
                                            (En carrito: <strong x-text="cantidadEnCarrito"></strong>)
                                        </span>
                                    </template>

                                    <span class="text-[10px] md:text-xs text-blue-600 dark:text-blue-400 ml-2">
                                        Stock restante:
